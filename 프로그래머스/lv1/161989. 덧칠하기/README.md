...
<a href="https://school.programmers.co.kr/learn/courses/30/lessons/161989">- 문제링크</a>

## 성능 요약

메모리: 33.5MB, 시간: 1.99ms
...
- 1 ≤ section의 길이 ≤ n
- 1 ≤ section의 원소 ≤ n
- section의 원소는 페인트를 다시 칠해야 하는 구역의 번호입니다.상태를 나타냅니다.
...
- 예제 1번은 2, 3, 6번 영역에 페인트를 다시 칠해야 합니다. 롤러의 길이가 4미터이므로 한 번의 페인트칠에 연속된 4개의 구역을 칠할 수 있습니다. 처음에 3, 4, 5, 6번 영역에 페인트칠을 하면 칠해야 할 곳으로 2번 구역만 남고 1, 2, 3, 4번 구역에 페인트칠을 하면 2번 만에 다시 칠해야 할 곳에 모두 페인트칠을 할 수 있습니다.
  <img width="374" alt="image" src="https://github.com/wuzoo/Solving_problem/assets/121484561/515ff819-91c0-4afe-9cf5-72c091e7dcb9">
...
- 예제 2번은 1, 3번 영역에 페인트를 다시 칠해야 합니다. 롤러의 길이가 4미터이므로 한 번의 페인트칠에 연속된 4개의 구역을 칠할 수 있고 1, 2, 3, 4번 영역에 페인트칠을 하면 한 번에 1, 3번 영역을 모두 칠할 수 있습니다.
  <img width="327" alt="image" src="https://github.com/wuzoo/Solving_problem/assets/121484561/4f6211b6-3eb2-44d6-8424-d8ced8404b2e">
